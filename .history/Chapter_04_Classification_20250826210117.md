...
public class KNNClassifier implements Classifier {
    ...
    private List<ClassificationDataPoint> findKNearestNeighbors(Map<String, Double> features) {
        return trainingData.stream()
                .sorted((p1, p2) -> Double.compare(
                    euclideanDistance(features, p1.getFeatures()),
                    euclideanDistance(features, p2.getFeatures())
                ))
                .limit(k)
     ...
     */
    private double euclideanDistance(Map<String, Double> features1, Map<String, Double> features2) {
        double sum = 0.0;
