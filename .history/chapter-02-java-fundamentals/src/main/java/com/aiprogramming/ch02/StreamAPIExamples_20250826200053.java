...
public class StreamAPIExamples {
    ...
    private static void demonstrateAdvancedStreamOperations() {
        ...
        logger.info("     Average: {}", String.format("%.2f", stats.getAverage()));
        ...
        logger.info("   Total score: {}", String.format("%.2f", totalScore));
    ...
    private static void demonstrateParallelProcessing() {
        ...
        double parallelAverage = Arrays.stream(values)
            ...
            .orElse(0.0);
        endTime = System.currentTimeMillis();
        logger.info("   Parallel average: {} (took {}ms)", String.format("%.2f", parallelAverage), endTime - startTime);
    }
    ...
    private static void demonstrateCustomCollectors() {
        ...
        logger.info("   Weighted average: {}", String.format("%.2f", weightedAverage));
    }
