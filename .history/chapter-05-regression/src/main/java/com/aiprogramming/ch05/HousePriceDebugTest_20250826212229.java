...
public class HousePriceDebugTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Any NaN in actuals: " + actuals.stream().anyMatch(Double::isNaN));
        System.out.println("Any NaN in predictions: " + predictions.stream().anyMatch(Double::isNaN));
        System.out.println("Any NaN in coefficients: " + lr.getCoefficients().values().stream().anyMatch(Double::isNaN));
